...
class SepetViewModel : ViewModel() {
    ...
    val sepetListesi = MutableLiveData<SepetCevap>()
    ...
    fun sepetGetir(
        ...
        disposable.add(
            apiServis.get028SepetGetirX(
                ...
                .subscribeWith(object : DisposableSingleObserver<SepetCevap>() {
                    override fun onSuccess(t: SepetCevap) {
                        sepetListesi.value = t
