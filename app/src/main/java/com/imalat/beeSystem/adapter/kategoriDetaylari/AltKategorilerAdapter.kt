...
class AltKategorilerAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHpolder, position: Int) {
        ...
        holder.view.radioButton.setOnClickListener {
            ...
            kategoriyeGoreKAtegoriVeUrunGetir.ikinciAltKategoriGetir(list[position].kategoriID)
